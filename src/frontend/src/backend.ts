...
export class Backend implements backendInterface {
    ...
    async getLeaderboard(arg0: string, arg1: bigint): Promise<Array<QuizAttempt>> {
    ...
    async saveQuizAttempt(arg0: QuizAttemptInput): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.saveQuizAttempt(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
